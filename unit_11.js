...
function f12() {
    i_12 = +document.querySelector(".i-12").value;
    out_12 = "";
...
function f15() {
    out_15 = "";
    i_15 = +document.querySelector(".i-15").value;
    d15.indexOf(i_15);
...
function f18() {
    ...
    out_18 =  d18.includes(i_18);
    document.querySelector(".out-18").innerHTML = out_18;
}
...
function f19() {
    ...
    for(let i = 1; i < d19.length; i++){
        if(d19[i].length > m.length){
            m = d19[i];
            }
    }
document.querySelector(".out-19").innerHTML = m;
}
